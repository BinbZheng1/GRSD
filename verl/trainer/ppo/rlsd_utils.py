"""Shared skill-provider utilities used by GRSD's teacher path.

Skill mappings are loaded from ``skill_mapping.json``, making the provider
environment-agnostic. The legacy module name is retained because the GRSD
trainer reuses this small, stable implementation.
"""
